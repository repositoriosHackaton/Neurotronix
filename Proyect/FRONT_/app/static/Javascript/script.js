...
// Manejo de la zona de arrastre de archivos
  ...
  if (validExtensions.includes(docType)) {
    ...
    fileReader.addEventListener("load", (e) => {
      ...
      const html = document.querySelector(
        "#drop-area-container__preview"
      ).innerHTML;
      document.querySelector("#drop-area-container__preview").innerHTML =
        image + html;
    });
...
async function uploadFile(file, id) {
  ...
  try {
    // Aquí debes poner el link del servidor o host
